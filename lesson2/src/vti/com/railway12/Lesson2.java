...
//		System.out.println("Phòng ban: " + accArray5[i].department.departmentName);
//			}
//		i++;
//		};
//		
...
//		System.out.println("Thông tin account " + (i1+1));
//		System.out.println("Email: " + accArray6[i1].email);
//		System.out.println("Full name: " + accArray6[i1].fullName);
//		System.out.println("Phòng ban: " + accArray6[i1].department.departmentName);
//			}
//		i1++;
//		};
...
//		int i2 = 0;
//		do {
//			System.out.println("Thông tin account " + (i2+1));
//			System.out.println("Email: " + accArray9[i2].email);
//			System.out.println("Full name: " + accArray9[i2].fullName);
//			System.out.println("Phòng ban: " + accArray9[i2].department.departmentName);
//			i2++;
...
//		do {
//			if (i3 != 1 ) {
//		System.out.println("Thông tin account " + (i3+1));
//		System.out.println("Email: " + accArray7[i3].email);
//		System.out.println("Full name: " + accArray7[i3].fullName);
//		System.out.println("Phòng ban: " + accArray7[i3].department.departmentName);
//			}
//		i3++;
...
//		System.out.println("Thông tin account " + (i4+1));
//		System.out.println("Email: " + accArray8[i4].email);
//		System.out.println("Full name: " + accArray8[i4].fullName);
//		System.out.println("Phòng ban: " + accArray8[i4].department.departmentName);
//			}
//		i4++;
